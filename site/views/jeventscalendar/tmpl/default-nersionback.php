...
$eventsInline = "";
$eventsInline .= '[{ "date": "'.$fechainicio.'", "type": "meeting", "title": "'.$titulo.'", "description": "'.$descripcion.'", "url": "'.JURI::base().'index.php?option=com_jeventscalendar&view=jeventscalendar&id='.$id.'" },';
foreach ($this->msg['items'] as $row) {
				...
				$eventsInline .= '{ "date": "'.$fini.'", "type": "meeting", "title": "'.$row->title.'", "description": "'.$row->description.'", "url": "'.$url.'" },';
			}
$eventsInline .= ']';
